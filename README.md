# Extra Bases — Z80 Source Reconstruction

This repository contains the disassembly, source code reconstruction, and technical documentation for the classic arcade game **Extra Bases** (Bally/Midway, 1980).
...
* **Primary Source:** `src/eb_disassembly.asm`
...
The script will automatically compile the assembly and deposit the final, ready-to-play binaries (`m761a` through `m761d`) along with the packaged `extrabas.zip` into a new `roms/` folder in your project root.
...
│   ├── extra_bases_hardware_reference.md  # Hardware specifications
...
├── src/
│   ├── eb_disassembly.asm                 # Main Z80 source disassembly
